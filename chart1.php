    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
        <section class="section">
              ...
              <div class="col-12">
                <div class="card card-primary">
                  <div class="card-header">
                    <h4>Menampilkan jumlah film berdasarkan kategori</h4>
                  </div>
                  <div class="card-body">
          ...
          $sql = "SELECT kategori,COUNT(judul) as 'total' FROM film GROUP BY kategori ORDER BY total DESC";
